...
constexpr int NUM_SUBJECTS = 50;
constexpr int NUM_ACTIONS = 50;
constexpr int NUM_REASONS = 50;

// ============================================================================
// Array 1: Subjects (50 elements)
// No accented characters for console compatibility
// ============================================================================

constexpr std::array<const char*, NUM_SUBJECTS> SUBJECTS = {
    "George Bush",
    "Albert Einstein",
    "el Papa Francisco",
...
constexpr std::array<const char*, NUM_ACTIONS> ACTIONS = {
...
constexpr std::array<const char*, NUM_REASONS> REASONS = {
...
[[nodiscard]] std::string generateAbsurdFact();
